...
| **P3** Rédaction des Parties I à VI (ch. 1 à 21) | 21 pièces | ◐ | ouverte le 21 juill. 2026 | **Partie I rédigée (ch. 1 à 4), premier jet** — 11 843 mots pour 11 000 de cible (+7,7 %). ⚠ **Relecture adversariale rendue : `A_CORRIGER` sur les quatre pièces, 14 réfutations bloquantes, correctifs NON appliqués** ([rapport](../verification/relecture-P3-partie-I.md)). Le point 6 de la boucle §5.2 reste à exécuter. Ch. 5 à 21 : ☐ |
...
| **P3** — Rédaction du tronc (ch. 1-21) | J-4 | ◐ | 21 juill. 2026 | | `monographie/01-partie-I/` — quatre pièces au premier jet ; `verification/relecture-P3-partie-I.md` | *(à renseigner à la clôture)* ⚠ **Constat d'étape** : la relecture adversariale rend `A_CORRIGER` sur les quatre pièces. Le défaut dominant est **le même qu'aux phases précédentes** — la borne du socle perdue dans la prose — ce qui en fait un défaut de **niveau d'écriture**, non de phase |
