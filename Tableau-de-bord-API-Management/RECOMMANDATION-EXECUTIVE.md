...
> **Note d'audit.** Vérification de cohérence (juin 2026) : le critère **Sim 1 C10 — TCO & commercial (poids 6)** figure bien dans la source de vérité (`data.js` et la matrice d'évaluation de la Sim 1), avec **Kong 4,0 · IBM 3,5 · Apigee 3,5 · MuleSoft 3,0 · Azure 4,0**. Sur ce critère précis, **Kong devance IBM** — ce qui conforte (sans le fonder à lui seul) l'argument TCO en faveur de Kong, aux côtés de Sim 2 C11 et des réserves nommées. À ne pas confondre avec le classement général : **MuleSoft (3,0) est la note la plus basse du panel sur C10**, tandis qu'au total Sim 1 c'est **Azure APIM (82,9)** qui ferme la marche. Toutes les valeurs citées dans ce document sont traçables jusqu'à la source de vérité ; aucune donnée hors source n'y subsiste.
